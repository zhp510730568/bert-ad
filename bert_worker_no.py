...
def main(_):
  ...
  checkpoint_path='./model/ad/model_0624/model.ckpt-610205'
  ...
  for no in range(100):
    suffix=10139-no
    slice_path='/data1/zhangpengpeng/ad_data/eval_ins2_20190628/slice_%s' % str(suffix)[1:]
    slice_output_path=os.path.join('/data1/zhangpengpeng/ad_data/eval_ins2_20190628/', 'slice_output_%s' % str(suffix)[1:])
    ...
    with tf.gfile.Open(slice_path, 'r') as f:
      ...
      for index, line in enumerate(f):
        ...
        text_c=None
        start_position=None
        feature=get_example(tokenizer, text_a, text_b, text_c, start_position, 60)
