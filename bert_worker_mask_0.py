...
def main(_):
  ...
  for no in range(140):
    suffix=10000+no
    slice_path='/data1/zhangpengpeng/ad_data/eval_ins2_20190629/slice_%s' % str(suffix)[1:]
    slice_output_path=os.path.join('/data1/zhangpengpeng/ad_data/eval_ins2_20190629/', 'slice_output_%s' % str(suffix)[1:])
