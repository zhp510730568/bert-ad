...
def main(_):
  ...
  checkpoint_path='model/ad/model_pretrain_1021/model.ckpt-406796'
  ...
  input_path='/data1/zhangpengpeng/ad_data/new_eval_ins2/v1021'

  output_path='/data1/zhangpengpeng/ad_data/new_eval_ins2/v1021'
  start=time.time()
  for no in range(2):
    suffix=10000+no
