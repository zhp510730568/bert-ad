...
def main(_):
  ...
  checkpoint_path='./model/ad/model_pretrain_v0620_0801/model.ckpt-204000'
  checkpoint_path='./model/ad/model_pretrain_0801/model.ckpt-610194'
  ...
  input_path='/data1/zhangpengpeng/ad_data/eval_ins2_20190629/'
  input_path='/data1/zhangpengpeng/ad_data/eval_ins2_20190809'
 
  output_path='/data1/zhangpengpeng/ad_data/eval_ins2_20190809/'
  start=time.time()
  for no in range(2):
    suffix=10000+no
    slice_path=os.path.join(input_path, 'slice_%s' % str(suffix)[1:])
    slice_output_path=os.path.join(output_path, 'slice_output_%s' % str(suffix)[1:])
